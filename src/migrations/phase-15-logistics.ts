...
export async function up(queryInterface: QueryInterface): Promise<void> {
  ...
  await queryInterface.createTable(
    'freight_quotes',
    {
      ...
      truck_type: { type: DataTypes.STRING(50), allowNull: true },
      truck_capacity: { type: DataTypes.STRING(50), allowNull: true },
      wagon_type: { type: DataTypes.STRING(50), allowNull: true },
      wagon_capacity: { type: DataTypes.STRING(50), allowNull: true },
