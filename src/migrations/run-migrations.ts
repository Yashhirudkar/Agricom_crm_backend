...
async function run() {
  ...
  try {
    ...
    await sequelize.transaction(async (transaction) => {
      ...
      // Add raw queries or Sequelize QueryInterface commands inside this block.
      // Example:
      // await sequelize.query(`CREATE TABLE IF NOT EXISTS "example" ("id" SERIAL PRIMARY KEY);`, { transaction });
      // ----------------------------------------------------------------------
